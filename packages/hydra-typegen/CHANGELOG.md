...
* **hydra-indexer:** bump polkadot.js to 7.9.1 ([#178](https://github.com/Joystream/hydra/issues/178)) ([bb2f1d7](https://github.com/Joystream/hydra/commit/bb2f1d70696b281fe35e0b001ea420b6badadade))
...
* **hydra-indexer:** livness probe after test ([#173](https://github.com/Joystream/hydra/issues/173)) ([e441000](https://github.com/Joystream/hydra/commit/e4410003f363cdcfd6a398accfe04c05771e522d))
...
* **hydra-moonriver-indexer-gateway:** fix permissions for evm_log ([a2c3df9](https://github.com/Joystream/hydra/commit/a2c3df92a43d82092c70db3ea4d00ee06735903f))
...
* fixed bug with returning metrics in json format ([be45403](https://github.com/Joystream/hydra/commit/be454033b6dd99ad943792a3b2481eda470d0e91))
...
* **hydra-indexer:** stop an indexer if no activity within INACTIVITY_TIMEOUT_MS ([76fa589](https://github.com/Joystream/hydra/commit/76fa589c95e1ffdb00eac87dd8892619af9e3cab))
...
* **hydra-processor:** add extrinsic id to the block header to new indexers ([af701d6](https://github.com/Joystream/hydra/commit/af701d6ed686617757410536ea8b2556385add50))
...
* fixed version type in delete command ([e848b6b](https://github.com/Joystream/hydra/commit/e848b6bb007f76994e82188b1d9aee39c199be07))
...
* yaml schema error ([13a3fe6](https://github.com/Joystream/hydra/commit/13a3fe6e61eb7a8efa2dfc555b98806aed93cb0f))
...
* **hydra-indexer:** add missing FK indices to the schema ([#146](https://github.com/Joystream/hydra/issues/146)) ([7662963](https://github.com/Joystream/hydra/commit/7662963bd6685718732b7ff3eca11d465bbd8fc6))
...
* **hydra-processor:** replace block filters with id filters  ([#138](https://github.com/Joystream/hydra/issues/138)) ([2b51167](https://github.com/Joystream/hydra/commit/2b511672744d490dc76c53058cf6ce37dd8acf87))
...
* remove all typegen validations ([#131](https://github.com/Joystream/hydra/issues/131)) ([d86ba8b](https://github.com/Joystream/hydra/commit/d86ba8b79a30221175726203725f97a88a5a8ee1))
...
* relax typegen validation rules ([#130](https://github.com/Joystream/hydra/issues/130)) ([14e5eb3](https://github.com/Joystream/hydra/commit/14e5eb36ce938dadaa0d3bb6c904e926ea57f79c))
...
* json list codegen issues ([#125](https://github.com/Joystream/hydra/issues/125)) ([9989361](https://github.com/Joystream/hydra/commit/9989361b2327c486192338ee87644f1cfdb7fb09))
...
## [5.0.0-alpha.0](https://github.com/Joystream/hydra/compare/v4.2.0-alpha.5...v5.0.0-alpha.0) (2021-10-16)


### Features

* introduce v5 ([#121](https://github.com/Joystream/hydra/issues/121)) ([ed5967b](https://github.com/Joystream/hydra/commit/ed5967bc53a795d1b36390472d073cad83d6eed4))
